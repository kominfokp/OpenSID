...
<div id="penduduk" class="box box-info <?php if ($kategori !='penduduk'): ?>collapsed-box<?php endif ?>">
	...
	<div class="box-body no-padding">
      ...
      <li class="<?php ($lap==17) and print('active') ?>"><a href="<?=site_url('statistik/clear/17')?>">Akte Kelahiran</a></li>
			...
			<li class="<?php ($lap==18) and print('active') ?>"><a href="<?=site_url('statistik/clear/19')?>">Status Hub dalam Keluarga</a></li>
			<li class="<?php ($lap==18) and print('active') ?>"><a href="<?=site_url('statistik/clear/20')?>">Kepala Keluarga berdasar Jenis kelamin</a></li>
			<li class="<?php ($lap==18) and print('active') ?>"><a href="<?=site_url('statistik/clear/21')?>">Pendididikan Kepala keluarga</a></li>
			<li class="<?php ($lap==18) and print('active') ?>"><a href="<?=site_url('statistik/clear/22')?>">Pekerjaan Kepala Keluarga</a></li>
			<li class="<?php ($lap==18) and print('active') ?>"><a href="<?=site_url('statistik/clear/23')?>">Umur Kepala Keluarga</a></li>
