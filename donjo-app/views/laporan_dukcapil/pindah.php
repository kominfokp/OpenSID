<div class="content-wrapper">
	<section class="content-header">
		<h1>Laporan Pindah</h1>
		<ol class="breadcrumb">
			<li><a href="<?=site_url('hom_sid')?>"><i class="fa fa-home"></i> Home</a></li>
			<li class="active">Laporan Pindah</li>
								...
								<table class="table table-bordered dataTable table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td><?= $data->nik?></td>
											<td><?= $data->namaLgkp?></td>
											<td><?= $data->klasifikasiPindah?></td>
											<td><?= $data->alamatTujuan?></td>
											<td><?= $data->desaTujuan?></td>
											<td><?= $data->kecamatanTujuan?></td>
											<td><?= $data->kabupatenTujuan?></td>
											<td><?= $data->provinsiTujuan?></td>
