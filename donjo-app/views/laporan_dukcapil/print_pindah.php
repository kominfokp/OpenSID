					...
					<tbody>
						<tr>
							<td align="center" >
								...
								<h1>LAPORAN DATA <?= strtoupper($jenis)?></h1>
							</td>
						</tr>
						<tr>
								...
								<table class="border thick data">
									<thead>
										<tr class="thick">
											...
											<th class="thick">No Pindah</th>
											<th class="thick">Nik</th>
											<th class="thick">Nama</th>
											<th class="thick">Klasifikasi Pindah</th>
											<th class="thick">Alamat</th>
											<th class="thick">Desa</th>
											<th class="thick">Kecamatan</th>
											<th class="thick">kabupaten</th>
											<th class="thick">Provinsi</th>
											<th class="thick">Tgl Pindah</th>
										</tr>
									</thead>
									<tbody>
										<?php foreach ($content as $data): $i++; ?>
											<tr>
												<td class="thick" align="center" width="2"><?= $i?></td>
												<td class="thick" ><?= $data->noPindah?></td>
											<td class="thick" ><?= $data->nik?></td>
											<td class="thick" ><?= $data->namaLgkp?></td>
											<td class="thick" ><?= $data->klasifikasiPindah?></td>
											<td class="thick" ><?= $data->alamatTujuan?></td>
											<td class="thick" ><?= $data->desaTujuan?></td>
											<td class="thick" ><?= $data->kecamatanTujuan?></td>
											<td class="thick" ><?= $data->kabupatenTujuan?></td>
											<td class="thick" ><?= $data->provinsiTujuan?></td>
											<td class="thick" ><?= $data->createdDate?></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
									...
									<tbody>
										<tr>
											...
											<td class="top" align="center" width="30%">
												...
												<div class="nowrap"><strong style="text-transform: uppercase;"></strong></div>
												<div class="nowrap"><label>_________________________</label></div>
											</td>
										</tr>
									</tbody>
								</table>
