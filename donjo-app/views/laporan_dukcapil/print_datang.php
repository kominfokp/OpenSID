									...
									<tbody>
										<?php foreach ($content as $data): $i++; ?>
											<tr>
												...
												<td class="thick"><?= $data->alamatAsal?></td>
												<td class="thick"><?= $data->desaAsal?></td>
												<td class="thick"><?= $data->kecamatanAsal?></td>
												<td class="thick"><?= $data->kabupatenAsal?></td>
												<td class="thick"><?= $data->provinsiAsal?></td>
