								...
								<table class="border thick data">
									<thead>
										<tr class="thick">
											...
											<th class="thick">Tmpt Lahir</th>
											<th class="thick">Tgl Lahir</th>
											<th class="thick">Tempat Mati</th>
											<th class="thick">Tgl Mati</th>
											<th class="thick">No Akta Kematian</th>
									...
									<tbody>
										<?php foreach ($content as $data): $i++; ?>
											...
											<td class="thick"><?= $data->matiNik?></td>
											<td class="thick"><?= $data->matiNamaLgkp?></td>
											<td class="thick"><?= $data->matiTmptLahir?></td>
											<td class="thick"><?= $data->matiTglLahir?></td>
											<td class="thick"><?= $data->matiTmptMati?></td>
											<td class="thick"><?= $data->matiTglMati?></td>
