			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<div align="center"><u><h4 class="kop">SURAT KETERANGAN DOMISILI USAHA</h4></u></div>
					...
					<div id="isi3">
						...
						<table width="100%">
							<tr><td class="indentasi" colspan="3">Bahwa yang tersebut namanya diatas, memang benar penduduk kami yang memiliki usaha <?= $input['usaha']?>, berlokasi di Dusun <?= unpenetration($data['alamat_sekarang'])?>, <?= ucwords($this->setting->sebutan_desa)?> <?= unpenetration($desa['nama_desa'])?>, <?= ucwords($this->setting->sebutan_kecamatan_singkat)?> <?= unpenetration($desa['nama_kecamatan'])?>, <?= ucwords($this->setting->sebutan_kabupaten_singkat)?> <?= unpenetration($desa['nama_kabupaten'])?>.</td></tr>
						</table>
						<table width="100%">
