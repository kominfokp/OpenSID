...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Keterangan Nikah N5</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_desa/about')?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="<?= site_url('surat')?>"> Daftar Cetak Surat</a></li>
			<li class="active">Surat Keterangan Nikah N5</li>
		</ol>
	</section>
					...
					<form action="" id="main" name="main" method="POST" class="form-horizontal">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="nama_suami" class="form-control input-sm required" placeholder="Nama Calon Suami">
								</div>
							</div>
							<div class="form-group">
								<label for="opsi_pelaksanaan"  class="col-sm-3 control-label">Pelaksanaan</label>
								<div class="col-sm-4" style="font-weight: bold; font-size: 10px;">
									<input type="radio" name="opsi_pelaksanaan" value="Dilaksanakan">Dilaksanakan
									<input type="radio" name="opsi_pelaksanaan" value="Tidak Dilaksanakan">Tidak Dilaksanakan 
								</div>
							</div>
							<div class="form-group">
								<label for="persyaratan"  class="col-sm-3 control-label">Persyaratan</label>
								<div class="col-sm-4">
									<textarea  id="mytextarea" name="persyaratan"  style="height: 300px;"></textarea>
								</div>
							</div>
