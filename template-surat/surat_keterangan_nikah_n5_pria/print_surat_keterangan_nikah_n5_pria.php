				...
				<div>
					...
					<div id="isi3">
						...
						<tr>
							<td>
								<table width="100%">
									<tr><td>Dengan hormat, setelah dilakukan pemeriksaan terhadap persyaratan pendaftaran perkawinan yang diatur dalam peraturan perundang-undangan bahwa permohonan pendaftaran perkawinan atau rujuk Saudara : <b><?= unpenetration($data['nama'])?></b> dengan Saudari : <b><?= $input['nama_istri']?></b> diberitahukan sebagai berikut :</td></tr>
								</table>
