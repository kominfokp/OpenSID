...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Keterangan Nikah N4</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_desa/about')?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="<?= site_url('surat')?>"> Daftar Cetak Surat</a></li>
			<li class="active">Surat Keterangan Nikah N4</li>
		</ol>
	</section>
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="bin_ayah" class="form-control input-sm " placeholder="Bin">
							...
							<br><br>
							<div class="form-group">
								<label for="nama_ibu"  class="col-sm-3 control-label">Nama Lengkap dan alias</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label for="bin_ibu"  class="col-sm-3 control-label">Bin</label>
								<div class="col-sm-4">
									<input type="text" name="bin_ibu" class="form-control input-sm " placeholder="Bin">

								</div>
							</div>
							<div class="form-group">
								<label for="nik_ibu"  class="col-sm-3 control-label">NIK</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label for="nama_ibu"  class="col-sm-3 control-label">Nama Lengkap dan alias</label>
								<div class="col-sm-4">
									<input type="text" name="nama_calon" class="form-control input-sm required" placeholder="Nama ">
							...
							<div class="form-group">
								<label for="bin_ibu"  class="col-sm-3 control-label">Bin</label>
								<div class="col-sm-4">
									<input type="text" name="bin_calon" class="form-control input-sm required" placeholder="Bin">
							...
							<div class="form-group">
								<label for="nik_ibu"  class="col-sm-3 control-label">NIK</label>
								<div class="col-sm-4">
									<input type="text" name="nik_calon" class="form-control input-sm required" placeholder="NIK ">
							...
							<div class="form-group">
								<label for="tempat_lahir"  class="col-sm-3 control-label">Tempat dan tanggal lahir</label>
								<div class="col-sm-4">
									<input type="text" name="tempat_lahir_calon" class="form-control input-sm required" placeholder="Tempat Lahir">

								</div>
								<div class="col-sm-2">
									<input type="date" name="tgl_lahir_calon" class="form-control input-sm required" placeholder="">
							...
							<div class="form-group">
								<label for="kewarganegaraan"  class="col-sm-3 control-label">Kewarganegaraan</label>
								<div class="col-sm-4">
									<input type="text" name="kewarganegaraan_calon" class="form-control input-sm required" placeholder="Kewarganegaraan">
							...
							<div class="form-group">
								<label for="agama"  class="col-sm-3 control-label">Agama</label>
								<div class="col-sm-4">
									<input type="text" name="agama_calon" class="form-control input-sm required" placeholder="Agama">
							...
							<div class="form-group">
								<label for="pekerjaan"  class="col-sm-3 control-label">Pekerjaan</label>
								<div class="col-sm-4">
									<input type="text" name="pekerjaan_calon" class="form-control input-sm required" placeholder="Pekerjaan">
							...
							<div class="form-group">
								<label for="alamat"  class="col-sm-3 control-label">Alamat</label>
								<div class="col-sm-4">
									<input type="text" name="alamat_calon" class="form-control input-sm required" placeholder="Alamat">
