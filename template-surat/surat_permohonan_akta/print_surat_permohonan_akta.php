			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<div align="center"><u><h4 class="kop">SURAT PERMOHONAN AKTA LAHIR</h4></u></div>
					...
					<div id="isi3">
						...
						<table width="100%">
			                <tr><td class="indentasi" colspan="4">Mengajukan permohonan untuk diterbitkan penetapan Pengadilan Negeri sebagai persyaratan pencatatan peristiwa kelahiran dan penerbitan kutipan Akta Kelahiran atas nama:</td></tr>
			            </table>
			            <table width="100%">
							<tr><td width="25%">Nama</td><td width="3%">:</td><td width="62%"><?= unpenetration($input['nama_anak'])?> </td></tr>
