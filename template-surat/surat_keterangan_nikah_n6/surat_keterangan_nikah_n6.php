...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Keterangan Nikah N6</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_desa/about')?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="<?= site_url('surat')?>"> Daftar Cetak Surat</a></li>
			<li class="active">Surat Keterangan Nikah N6</li>
		</ol>
	</section>
				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="margin-top:20px;padding-top:10px;padding-bottom:10px"><strong>DATA ALM/ALMH</strong></label>
							</div>
							<br><br>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="tgl_meninggal"  class="col-sm-3 control-label">Tanggal Meninggal</label>
								<div class="col-sm-2">
									<input type="date" name="tgl_meninggal" class="form-control input-sm required" placeholder="Tanggal">

								</div>
							</div>
							<div class="form-group">
								<label for="tempat_meninggal"  class="col-sm-3 control-label">Tempat Meninggal</label>
								<div class="col-sm-4">
									<input type="text" name="tempat_meninggal" class="form-control input-sm required" placeholder="Tempat">
