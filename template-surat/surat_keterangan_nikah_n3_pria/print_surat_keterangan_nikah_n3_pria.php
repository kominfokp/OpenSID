		...
		<div id="content" class="container_12 clearfix">
			<div id="content-main" class="grid_7">
					...
					<div id="isi3">
						...
						<tr>
							...
							<!-- 	<table width="100%">
								...
								<table width="100%">
									<tr><td width="37%">Nama Lengkap</td><td width="2%">:</td><td width="61%"><b><?= $input['nama_istri']?></b></td></tr>
									<tr><td>Bin</td><td>:</td><td><?= $input['bin_istri']?></td></tr>
									<tr><td>NIK</td><td>:</td><td><?= $input['nik_istri']?></td></tr>
									<tr><td>Tempat dan tanggal lahir</td><td>:</td><td><?= $input['tempat_lahir_istri']?>, <?= date('d-m-Y', strtotime($input['tgl_lahir_istri'])); ?></td></tr>
									<tr><td>Kewarganegaraan</td><td>:</td><td><?= $input['kewarganegaraan_istri']?></td></tr>
									<tr><td>Agama</td><td>:</td><td><?= $input['agama_istri']?></td></tr>
									<tr><td>Pekerjaan</td><td>:</td><td><?= $input['pekerjaan_istri']?></td></tr>
									<tr><td>Alamat</td><td>:</td><td><?= $input['alamat_istri']?></td></tr>
								</table>
								<table width="100%">
				...
				<table width="100%">
					...
					<tr></tr>
					<tr></tr>
					<tr><td  align="center">( <b><?= unpenetration($data['nama'])?></b> )<td></td><td align="center"><center>( <b><?= $input['nama_istri']?></b> )</center></td></tr>
				</table>
