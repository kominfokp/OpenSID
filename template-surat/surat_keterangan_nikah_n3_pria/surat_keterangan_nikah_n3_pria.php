					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="bin_istri" class="form-control input-sm required" placeholder="Bin">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="nik_istri" class="form-control input-sm required" placeholder="NIK ">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="tempat_lahir_istri" class="form-control input-sm required" placeholder="Tempat Lahir">

								</div>
								<div class="col-sm-2">
									<input type="date" name="tgl_lahir_istri" class="form-control input-sm required" placeholder="">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="kewarganegaraan_istri" class="form-control input-sm required" placeholder="Kewarganegaraan">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="agama_istri" class="form-control input-sm required" placeholder="Agama">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="pekerjaan_istri" class="form-control input-sm required" placeholder="Pekerjaan">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="alamat_istri" class="form-control input-sm required" placeholder="Alamat">
